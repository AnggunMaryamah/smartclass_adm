...
<body>
            ...
            <div class="cards-grid" role="list">
                <article class="content-card" role="listitem" aria-labelledby="smp-basic">
                    ...
                    <div class="card-actions" style="justify-content:flex-start">
                        <a class="card-cta" href="/daftar?paket=smp-1">Daftar Paket</a>
                ...
                <article class="content-card" role="listitem" aria-labelledby="smp-ujian">
                    ...
                    <div class="card-actions" style="justify-content:flex-start">
                        <a class="card-cta" href="/daftar?paket=smp-2">Daftar Paket</a>
    ...
    <!-- PRICING -->
    <!-- PRICING -->
    <!-- ganti bagian pricing cards hardcoded dengan ini -->
    <section class="section" id="paket-harga">
        <div class="container pricing-wrap">
            <h2>💼 <span class="gradient-text">Paket & Harga</span></h2>
            <p>Pilih model pembayaran — Bulanan atau Semester. Harga sesuai yang dimasukkan guru.</p>
            ...
            <div class="pricing-grid">
                ...
                @forelse($kelas as $k)
                    <div class="pricing-card">
                        <div class="price-badge">{{ $k->nama_kelas }}</div>

                        <div class="price">
                            {{ 'Rp ' . number_format($k->harga, 0, ',', '.') }}
                        </div>

                        <div class="price-sub">per paket</div>

                        <p>{{ \Illuminate\Support\Str::limit($k->deskripsi, 120) }}</p>

                        <a href="#" class="btn">Detail</a>
                        {{-- Jika punya route detail kelas public, ganti '#' --}}
                    </div>
                @empty
                    <p style="text-align: center;">Belum ada kelas untuk jenjang ini.</p>
                @endforelse
                {{-- ================================================ --}}
            ...
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:18px;max-width:900px;margin:0 auto">
                ...
                <div
                    ...
                    <div
                        style="width:64px;height:64px;border-radius:12px;display:grid;place-items:center;margin:0 auto 10px;background:linear-gradient(135deg,var(--accent-from),var(--accent-to));color:white">
                        y</div>
                    <strong>Bu ye shungguang</strong>
