...
<head>
    ...
    <title>@yield('title') - SmartClass Admin</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg,#F5F7FA 0%,#EDF2F7 50%,#E8EEF3 100%);
        ...
        .dropdown-menu button:hover:not(:last-child) {
...
<main>
    ...
    <div class="top-bar">
        <div class="search-box">
            <input type="text" placeholder="Cari data, pengguna, atau transaksi...">
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (sidebarToggle && sidebar && sidebarOverlay) {
            ...
            sidebarOverlay.addEventListener('click', function() {
                if (typeof closeSidebarAdmin === 'function') {
                    closeSidebarAdmin();
                }
            });

            const navLinks = document.querySelectorAll('.sidebar-admin .nav-link');
