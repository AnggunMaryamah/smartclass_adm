...
<head>
    ...
    <style>
        ...
        .header {
            ...
            align-items: center;
            margin-bottom: 25px;
            border-bottom: 2px solid #e0e6ed; /* garis pemisah lembut */
            padding-bottom: 15px;
        }
        .header-left {
            display: flex;
        ...
        .card-lightblue { background-color: #90E0EF; color: #0B1D51; }
        .card-yellow { background-color: #FFC34B; color: #0B1D51; }
        .card-info:hover {
